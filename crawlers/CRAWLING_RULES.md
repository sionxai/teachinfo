...
| 1 | 나라일터 (gojobs.go.kr) | 공식 게시판 크롤링 | ✅ DONE | 18키워드 x 3p, 기관유형 자동분류 |
| 1 | 시도교육청 (5곳) | 공식 게시판 크롤링 | ✅ DONE | 서울/경기/인천/부산/대구. 나머지 12곳 TODO |
| 2 | 나라장터 | OpenAPI (data.go.kr) | TODO | 교육용역/위탁교육/멘토링 사업 |
| 2 | 지자체/도서관/평생학습관/청년센터/복지관 | 개별 게시판 | TODO | 준공공 강사 모집 핵심 소스 |
| 3 | Naver Search API | JSON API (developers.naver.com) | TODO | HTML 직접 크롤링 금지, 보조용 |
